...
void display_gender(D_SOCKET *dsock)
{
  ...
  text_to_buffer(dsock, "^AA^W) ^jMale\n\r");
...
{
  text_to_buffer(dsock, "\033c");
  text_to_buffer(dsock, "^AA^W) ^jCentaur\n\r");
  text_to_buffer(dsock, "^AB^W) ^jDruas\n\r");
  text_to_buffer(dsock, "^AC^W) ^jDwarf\n\r");
  text_to_buffer(dsock, "^AD^W) ^jElf\n\r");
  text_to_buffer(dsock, "^AE^W) ^jFerran\n\r");
  text_to_buffer(dsock, "^AF^W) ^jGnome\n\r");
  text_to_buffer(dsock, "^AG^W) ^jHuman\n\r");
  text_to_buffer(dsock, "^AH^W) ^jKobold\n\r");
  text_to_buffer(dsock, "^AI^W) ^jOgre\n\r");
  text_to_buffer(dsock, "^AJ^W) ^jOrc\n\r");
  text_to_buffer(dsock, "^AK^W) ^jRakashan\n\r");
  text_to_buffer(dsock, "^AL^W) ^jSaurian\n\r");
  text_to_buffer(dsock, "^AM^W) ^jWolfen\n\r");
  text_to_buffer(dsock, "\n\r\n\r^wPlease enter your choice: ");
}
...
case STATE_ASK_RACE:
      ...
      switch(arg[0]){
        case 'A':
          dsock->player->race = RACE_CENTAUR;
		dsock->player->stat_base[STAT_STRENGTH] = 10;
                dsock->player->stat_base[STAT_AGILITY] = 10;
                dsock->player->stat_base[STAT_ENDURANCE] = 10;
                dsock->player->stat_base[STAT_VITALITY] = 9;
                dsock->player->stat_base[STAT_INTELLIGENCE] = 7;
                dsock->player->stat_base[STAT_WILLPOWER] = 7;
                dsock->player->stat_base[STAT_PERCEPTION] = 9;
                dsock->player->stat_base[STAT_CHARISMA] = 7;
          dsock->state = STATE_INTO_GAME;
          break;
        case 'B':
          dsock->player->race = RACE_DRUAS;
                dsock->player->stat_base[STAT_STRENGTH] = 7;
                dsock->player->stat_base[STAT_AGILITY] = 10;
                dsock->player->stat_base[STAT_ENDURANCE] = 7;
                dsock->player->stat_base[STAT_VITALITY] = 7;
                dsock->player->stat_base[STAT_INTELLIGENCE] = 10;
                dsock->player->stat_base[STAT_WILLPOWER] = 9;
                dsock->player->stat_base[STAT_PERCEPTION] = 9;
                dsock->player->stat_base[STAT_CHARISMA] = 9;
          dsock->state = STATE_INTO_GAME;
          break;
        case 'C':
          dsock->player->race = RACE_DWARF;
                dsock->player->stat_base[STAT_STRENGTH] = 10;
                dsock->player->stat_base[STAT_AGILITY] = 7;
                dsock->player->stat_base[STAT_ENDURANCE] = 10;
                dsock->player->stat_base[STAT_VITALITY] = 10;
                dsock->player->stat_base[STAT_INTELLIGENCE] = 9;
                dsock->player->stat_base[STAT_WILLPOWER] = 9;
                dsock->player->stat_base[STAT_PERCEPTION] =7;
                dsock->player->stat_base[STAT_CHARISMA] = 7;
          dsock->state = STATE_INTO_GAME;
          break;
        case 'D':
          dsock->player->race = RACE_ELF;
                dsock->player->stat_base[STAT_STRENGTH] = 7;
                dsock->player->stat_base[STAT_AGILITY] = 10;
                dsock->player->stat_base[STAT_ENDURANCE] = 9;
                dsock->player->stat_base[STAT_VITALITY] = 9;
                dsock->player->stat_base[STAT_INTELLIGENCE] = 10;
                dsock->player->stat_base[STAT_WILLPOWER] = 9;
                dsock->player->stat_base[STAT_PERCEPTION] = 10;
                dsock->player->stat_base[STAT_CHARISMA] = 9;
          dsock->state = STATE_INTO_GAME;
          break;
        case 'E':
          dsock->player->race = RACE_FERRAN;
                dsock->player->stat_base[STAT_STRENGTH] = 7;
                dsock->player->stat_base[STAT_AGILITY] = 9;
                dsock->player->stat_base[STAT_ENDURANCE] = 9;
                dsock->player->stat_base[STAT_VITALITY] = 9;
                dsock->player->stat_base[STAT_INTELLIGENCE] = 9;
                dsock->player->stat_base[STAT_WILLPOWER] = 9;
          ...
          break;
        case 'F':
          dsock->player->race = RACE_GNOME;
                dsock->player->stat_base[STAT_STRENGTH] = 7;
                dsock->player->stat_base[STAT_AGILITY] = 9;
                dsock->player->stat_base[STAT_ENDURANCE] = 7;
                dsock->player->stat_base[STAT_VITALITY] = 7;
                dsock->player->stat_base[STAT_INTELLIGENCE] = 10;
                dsock->player->stat_base[STAT_WILLPOWER] = 10;
                dsock->player->stat_base[STAT_PERCEPTION] = 9;
                dsock->player->stat_base[STAT_CHARISMA] = 10;
          dsock->state = STATE_INTO_GAME;
          break;
        case 'G':
          dsock->player->race = RACE_HUMAN;
                dsock->player->stat_base[STAT_STRENGTH] = 8;
                dsock->player->stat_base[STAT_AGILITY] = 8;
                dsock->player->stat_base[STAT_ENDURANCE] = 8;
                dsock->player->stat_base[STAT_VITALITY] = 8;
                dsock->player->stat_base[STAT_INTELLIGENCE] = 8;
                dsock->player->stat_base[STAT_WILLPOWER] = 8;
                dsock->player->stat_base[STAT_PERCEPTION] = 8;
                dsock->player->stat_base[STAT_CHARISMA] = 8;
          dsock->state = STATE_INTO_GAME;
          break;
        case 'H':
          dsock->player->race = RACE_KOBOLD;
                dsock->player->stat_base[STAT_STRENGTH] = 7;
                dsock->player->stat_base[STAT_AGILITY] = 9;
                dsock->player->stat_base[STAT_ENDURANCE] = 9;
                dsock->player->stat_base[STAT_VITALITY] = 9;
          ...
          break;
        case 'I':
          dsock->player->race = RACE_OGRE;
                dsock->player->stat_base[STAT_STRENGTH] = 11;
                dsock->player->stat_base[STAT_AGILITY] = 6;
                dsock->player->stat_base[STAT_ENDURANCE] = 10;
                dsock->player->stat_base[STAT_VITALITY] = 10;
                dsock->player->stat_base[STAT_INTELLIGENCE] = 6;
                dsock->player->stat_base[STAT_WILLPOWER] = 7;
                dsock->player->stat_base[STAT_PERCEPTION] = 7;
                dsock->player->stat_base[STAT_CHARISMA] = 6;
          dsock->state = STATE_INTO_GAME;
          break;
        case 'J':
          dsock->player->race = RACE_ORC;
                dsock->player->stat_base[STAT_STRENGTH] = 10;
                dsock->player->stat_base[STAT_AGILITY] = 9;
                dsock->player->stat_base[STAT_ENDURANCE] = 10;
                dsock->player->stat_base[STAT_VITALITY] = 10;
          ...
          break;
        case 'K':
          dsock->player->race = RACE_RAKASHAN;
                dsock->player->stat_base[STAT_STRENGTH] = 9;
                dsock->player->stat_base[STAT_AGILITY] = 10;
                dsock->player->stat_base[STAT_ENDURANCE] = 9;
                dsock->player->stat_base[STAT_VITALITY] = 9;
                dsock->player->stat_base[STAT_INTELLIGENCE] = 9;
          ...
          break;
        case 'L':
          dsock->player->race = RACE_SAURIAN;
                dsock->player->stat_base[STAT_STRENGTH] = 9;
                dsock->player->stat_base[STAT_AGILITY] = 9;
                dsock->player->stat_base[STAT_ENDURANCE] = 10;
                dsock->player->stat_base[STAT_VITALITY] = 10;
      ...
      if (dsock->state == STATE_INTO_GAME)
      {
        text_to_buffer(dsock, (char *) do_echo);
